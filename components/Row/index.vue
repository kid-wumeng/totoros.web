   ...
   module.exports =
      props:
         ...
         'y':
            type: String
            default: 'top'
            validator: (value) => ['top', 'center', 'bottom', 'fill'].includes(value)

      computed:
         'rowClass': ->
            'x-left':    @x is 'left'
            'x-center':  @x is 'center'
            'x-right':   @x is 'right'
            'x-between': @x is 'between'
            'x-around':  @x is 'around'
            'y-top':     @y is 'top'
            'y-center':  @y is 'center'
            'y-bottom':  @y is 'bottom'
            'y-fill':    @y is 'fill'
</script>
